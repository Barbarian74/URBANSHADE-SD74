document.addEventListener('DOMContentLoaded', () => {
    ...
    const objectData = {
        '001': {
            ...
            description: 'Объект №001, также обозначаемый как «Предвестник Смерти», представляет собой результат аварийной активации аппаратуры пересылки сознания, произошедшей в ходе засекреченной операции ██-██-████. Изначально задействованный заместитель руководителя сектора (идентифицированный как Кирилл ████████) не нарушал протокол самостоятельно — его падение в активный контур системы было вызвано неизвестным третьим лицом. После контакта с устройством субъект физически погиб, но его сознание было зафиксировано и преобразовано в нестабильную форму псевдожизни. Состояние объекта: форма существования — неустойчивая. Оболочка и вид объекта могут изменяться; при визуальной идентификации чаще всего наблюдается искажённая гуманоидная фигура с нарушенной симметрией тела, неестественно вытянутым ротовым аппаратом. По всему периметру рта находятся острые клыки. Среда обитания: Предвестник проявляется исключительно в нижних секторах Hadal Complex. Зафиксировано лишь три появления в верхних коридорах, каждое из которых завершилось критическими потерями персонала. В 100% случаев появление объекта приводит к гибели. Протокол проявления: СБН (Система Безопасности и Навигации) обнаруживает аномалию и переводит освещение в аварийный режим. Мебель и шкафные модули в зоне поражения начинают хаотично открываться и захлопываться. Объявляется режим немедленной эвакуации или, при невозможности — укрытие в ближайшем шкафу. Механика взаимодействия: в случае, если сотруднику удалось укрыться в шкафу до прямого контакта с объектом, инициируется аномальная мини-игра. На протяжении 10 минут субъект, укрывшийся внутри, ощущает тяжёлое сердцебиение, внутреннее давление и ментальное расстройство — в этот период фиксируются скачки ЭКГ, падение пульса, кратковременные остановки дыхания. Если сотрудник не выдерживает давление (биологическое или психогенное) — наступает смерть. История инцидентов: первый зафиксированный случай: тело сотрудника █████████ было разорвано на части, внутренности покрыли стены, потолок и остекление лаборатории. Коридор H-2: разбитие окна из-за близости Предвестника привело к обрушению давления — 10 сотрудников утонули. Изолированный инцидент: после контакта с Предвестником, сотрудник ████ попытался установить голосовой контакт — зафиксировано мгновенное исчезновение сигнала биотрекеров. Особенности: полностью игнорирует физические барьеры. Имеет доступ к подсистемам комплекса, в ряде случаев СБН отказывается реагировать или выполняет ошибочные команды. Любая попытка контакта или наблюдения приводит к аномальному психическому отклонению, судорогам, смерти. Примечание: объект не заражает, не клонирует и не воспроизводит себя. Его действия — исключительно агрессивны и целенаправленны. Предполагается, что в основе поведения лежит сознание Кирилла, искажённое в результате несчастного случая.'
        },
        '014': {
            id: '#014',
